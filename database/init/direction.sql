-- MariaDB dump 10.19  Distribute 10.7.3-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: location-recommendation
-- ------------------------------------------------------
-- Server version	10.10.2-MariaDB-1:10.10.2+maria~focal
...
CREATE TABLE `direction` (
                             ...
                             `target_location_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                             PRIMARY KEY (`id`)
